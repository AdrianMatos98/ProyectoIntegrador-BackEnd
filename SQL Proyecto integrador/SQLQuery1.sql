...
use restauranteInteligente
--ENTREDAS--
INSERT INTO TB_PLATILLO VALUES('Anticuchos de Corazón','El anticucho es un tipo de brocheta de origen peruano, ​ que también es popular en algunos países sudamericanos con diferentes variaciones por país. Consiste en carne y otros alimentos que se asan ensartados en un pincho',10,1,5)
INSERT INTO TB_PLATILLO VALUES('Arroz Árabe','Receta de arroz árabe.Una receta clásica para acompañar carnes asadas y al horno, ideal para las cena de navidad o año nuevo.',4,1,5)
INSERT INTO TB_PLATILLO VALUES('Camarones al Ajillo','Plato confeccionado a base de Camarones y Ajo. Género. Plato Principal de la cocina Internacional. Ingredientes. Camarones, Ajo, Mantequilla, Jugo de Limón',5,1,5)
INSERT INTO TB_PLATILLO VALUES('Causa Rellena','La causa rellena es una receta sencilla de preparar, sin embargo suele resultar un tanto trabajosa porque se tiene que amasar la papa sancochada a mano. A continuación vamos a dar la relación de ingredientes. La cantidad de calorías indicada, es para 100 gramos.',3,1,5)
INSERT INTO TB_PLATILLO VALUES('Cebiche Mixto','El cebiche mixto o cebiche con mariscos es la expresión máxima de la riqueza marina que existe en la cocina peruana. Esta vez presentamos la receta más popular de la gastronomía inca, pero el abanico de posibilidades de ingredientes, es infinito.',3,1,5)
INSERT INTO TB_PLATILLO VALUES('Cebiche de Champiñones','Sabe muy bien elíjalo para su deguste',9,1,5)
INSERT INTO TB_PLATILLO VALUES('Cebiche de Pollo','Sabe muy bien elíjalo para su deguste',9,1,5)
INSERT INTO TB_PLATILLO VALUES('Club Sandwich','Sabe muy bien elíjalo para su deguste',9,1,5)
INSERT INTO TB_PLATILLO VALUES('Choclo con Mantequilla','Sabe muy bien elíjalo para su deguste',4,1,5)
INSERT INTO TB_PLATILLO VALUES('Choritos a la Chalaca','Sabe muy bien elíjalo para su deguste',3,1,5)
INSERT INTO TB_PLATILLO VALUES('Coliflor Gratinada','Sabe muy bien elíjalo para su deguste',7,1,5)
INSERT INTO TB_PLATILLO VALUES('Croquetas de Atún','Sabe muy bien elíjalo para su deguste',9,1,5)
INSERT INTO TB_PLATILLO VALUES('Conchitas a la Parmesana','Sabe muy bien elíjalo para su deguste',9,1,5)
INSERT INTO TB_PLATILLO VALUES('Empanada Mixta','Sabe muy bien elíjalo para su deguste',8,1,5)
INSERT INTO TB_PLATILLO VALUES('Empanadas','Sabe muy bien elíjalo para su deguste',4,1,5)
INSERT INTO TB_PLATILLO VALUES('Encurtidos','Sabe muy bien elíjalo para su deguste',8,1,5)
INSERT INTO TB_PLATILLO VALUES('Ensalada Cesar','Sabe muy bien elíjalo para su deguste',4,1,5)
INSERT INTO TB_PLATILLO VALUES('Ensalada de Chonta','Sabe muy bien elíjalo para su deguste',3,1,5)
INSERT INTO TB_PLATILLO VALUES('Ensalada de Arroz Medit','Sabe muy bien elíjalo para su deguste',8,1,5)
INSERT INTO TB_PLATILLO VALUES('Ensalada de Pollo','Sabe muy bien elíjalo para su deguste',6,1,5)


--CRIOLLO--
INSERT INTO TB_PLATILLO VALUES('Adobo a la Norteña','Es un plato titpico del norte del Perú con algunas variantes.',17,1,1)
INSERT INTO TB_PLATILLO VALUES('Adobo de Cerdo','El adobo es la inmersión de un alimento crudo en un preparado en forma de caldo (o salsa) de distintos componentes: pimentón(el más habitual), orégano, sal, ajos y vinagre, mezclados según el lugar de procedencia y alimento en el que se vaya a usar, destinado principalmente a conservar y realzar el alimento',16,1,1)
INSERT INTO TB_PLATILLO VALUES('Ají de Camarones','El ají de camarones es un plato delicioso muy representativo y que a muchas personas les gusta.',16,1,1)
INSERT INTO TB_PLATILLO VALUES('Ají de Champiñones','Este plato lo tenía escondido. Es también uno de los platos más famosos de la gastronomía peruana ',18,1,1)
INSERT INTO TB_PLATILLO VALUES('Ají de Gallina','El ají de gallina es un plato oriundo del Perú, consiste en un ají o crema espesa con pechuga de gallina deshilachada. Esta crema es servida con papas cocidas, y en ocasiones arroz blanco. Es usual reemplazar la gallina por pollo.',20,1,1)
INSERT INTO TB_PLATILLO VALUES('Ajiaco de Caiguas','Sabe muy bien elíjalo para su deguste',18,1,1)
INSERT INTO TB_PLATILLO VALUES('Ajiaco de Ollucos','Sabe muy bien elíjalo para su deguste',16,1,1)
INSERT INTO TB_PLATILLO VALUES('Albondigas','Sabe muy bien elíjalo para su deguste',10,1,1)
INSERT INTO TB_PLATILLO VALUES('Arrimado de Col','Sabe muy bien elíjalo para su deguste',14,1,1)
INSERT INTO TB_PLATILLO VALUES('Arroz Chaufa','Sabe muy bien elíjalo para su deguste',20,1,1)
INSERT INTO TB_PLATILLO VALUES('Arroz a la Jardinera','Sabe muy bien elíjalo para su deguste',15,1,1)
INSERT INTO TB_PLATILLO VALUES('Arroz con Chancho','Sabe muy bien elíjalo para su deguste',12,1,1)
INSERT INTO TB_PLATILLO VALUES('Arroz con Mariscos','Sabe muy bien elíjalo para su deguste',10,1,1)
INSERT INTO TB_PLATILLO VALUES('Arroz con Pato','Sabe muy bien elíjalo para su deguste',13,1,1)
INSERT INTO TB_PLATILLO VALUES('Arroz con Pollo','Sabe muy bien elíjalo para su deguste',16,1,1)
INSERT INTO TB_PLATILLO VALUES('Arroz Tapado','Sabe muy bien elíjalo para su deguste',20,1,1)
INSERT INTO TB_PLATILLO VALUES('Asado de Carne','Sabe muy bien elíjalo para su deguste',12,1,1)
INSERT INTO TB_PLATILLO VALUES('Bistec a lo Pobre','Sabe muy bien elíjalo para su deguste',12,1,1)
INSERT INTO TB_PLATILLO VALUES('Bistec Apanado','Sabe muy bien elíjalo para su deguste',12,1,1)
INSERT INTO TB_PLATILLO VALUES('Cabrito Norteño','Sabe muy bien elíjalo para su deguste',18,1,1)




--SOPAS--
INSERT INTO TB_PLATILLO VALUES('Aguadito','Es una sopa de pollo tradicionalen la cocina peruana que consiste en pollo, cilantro y verduras',7,1,4)
...
INSERT INTO TB_PLATILLO VALUES('Caldo de Gallina','El caldo de pollo (denominado a veces como sopa de pollo o caldo de gallina) es una sopa.​ A menudo se sirve con trozos de carne o con granos de arroz o cebada, pasta, zanahoria amarilla, apio, cebolla blanca, etc.',9,1,4)
INSERT INTO TB_PLATILLO VALUES('Chilcano de Pescado','El chilcano es un caldo o sopa muy consumido en la costa norte del Perú. que se prepara principalmente con la cabeza del pescado bonito, cochayuyo y bastante limón. Se consume preferentemente caliente. Tiene propiedades energéticas dada la gran cantidad de proteínas que contiene y tiene fama de “levanta muertos”',5,1,4)
INSERT INTO TB_PLATILLO VALUES('Crema de Espárragos','La crema de espárragos verdes casera es una receta vegetariana muy colorida y con un sabor inigualable.  La crema se prepara con patatas, espárragos verdes y leche evaporada Ideal, tu alternativa a la nata, y se sirve fría o caliente con las puntas de los espárragos como decoración. ¡Simple y deliciosa!',9,1,4)
INSERT INTO TB_PLATILLO VALUES('Crema de Zapallo','Sabe muy bien elíjalo para su deguste',8,1,4)
INSERT INTO TB_PLATILLO VALUES('Espesado Chiclayano','Sabe muy bien elíjalo para su deguste',8,1,4)
INSERT INTO TB_PLATILLO VALUES('Patasca','Sabe muy bien elíjalo para su deguste',5,1,4)
INSERT INTO TB_PLATILLO VALUES('Puchero a la Limeña','Sabe muy bien elíjalo para su deguste',9,1,4)
INSERT INTO TB_PLATILLO VALUES('Sancochado a la Limeña','Sabe muy bien elíjalo para su deguste',6,1,4)
INSERT INTO TB_PLATILLO VALUES('Sopa a la Minuta','Sabe muy bien elíjalo para su deguste',5,1,4)
INSERT INTO TB_PLATILLO VALUES('Sopa Criolla','Sabe muy bien elíjalo para su deguste',8,1,4)
INSERT INTO TB_PLATILLO VALUES('Sopa de Pallares','Sabe muy bien elíjalo para su deguste',6,1,4)
INSERT INTO TB_PLATILLO VALUES('Sopa de Pollo','Sabe muy bien elíjalo para su deguste',7,1,4)
INSERT INTO TB_PLATILLO VALUES('Sopa Serrana','Sabe muy bien elíjalo para su deguste',6,1,4)
INSERT INTO TB_PLATILLO VALUES('Sopa Shambar','Sabe muy bien elíjalo para su deguste',7,1,4)
INSERT INTO TB_PLATILLO VALUES('Sopa Teóloga','Sabe muy bien elíjalo para su deguste',6,1,4)
INSERT INTO TB_PLATILLO VALUES('Sopa de Pollo Chun-Lee','Sabe muy bien elíjalo para su deguste',9,1,4)
INSERT INTO TB_PLATILLO VALUES('Sopa de Cebada y Hongos','Sabe muy bien elíjalo para su deguste',6,1,4)
INSERT INTO TB_PLATILLO VALUES('Sopa de Vegetales Tofu','Sabe muy bien elíjalo para su deguste',8,1,4)



--POSTRES--
INSERT INTO TB_PLATILLO VALUES('Alfajores con Manjarblnco','Alfajores artesanales de maicena y dulce de leche',5,1,4)
INSERT INTO TB_PLATILLO VALUES('Alfajores de Miel','Esta tradicional masa es la preferida de miles de argentinos, aunque no podemos titularnos como los inventores, ya que como el turrón, el almíbar o el mazapán, el alfajor es un invento culinario antiquísimo de origen árabe. La palabra deriva del árabe “al-hasú” que significa “relleno”.',3,1,4)
INSERT INTO TB_PLATILLO VALUES('Arroz con Leche','Arroz con leche. Postre típico de la gastronomía de múltiples países hecho cociendo lentamente el arrozen leche con azúcar. Se come frío o caliente. Se le suele echar canela, vainilla o cáscara de limón para aromatizarlo.',5,1,4)
INSERT INTO TB_PLATILLO VALUES('Arroz Zambito','El arroz zambito es un postre peruano, derivado del arroz con leche,  siendo el principal ingrediente la chancaca, el cual le otorga el característico color marrón, de ello la razón del nombre.',4,1,4)
INSERT INTO TB_PLATILLO VALUES('Bizcocho de Limón','Este postre es muy típico, sobre todo en Francia, y se ha hecho por abuelas durante generaciones. La parte de la historia que me gusta es que estas abuelas francesas miden los ingredientes del bizcocho con los tarros de yogur.',5,1,4)
INSERT INTO TB_PLATILLO VALUES('Bizcochos','Sabe muy bien elíjalo para su deguste',5,1,4)
INSERT INTO TB_PLATILLO VALUES('Bocadillo de Dama','Sabe muy bien elíjalo para su deguste',5,1,4)
INSERT INTO TB_PLATILLO VALUES('Borrachitos','Sabe muy bien elíjalo para su deguste',3,1,4)
INSERT INTO TB_PLATILLO VALUES('Bombas de Sémola','Sabe muy bien elíjalo para su deguste',5,1,4)
INSERT INTO TB_PLATILLO VALUES('Borrachitos de Chocolate','Sabe muy bien elíjalo para su deguste',3,1,4)
INSERT INTO TB_PLATILLO VALUES('Budín de Chancay','Sabe muy bien elíjalo para su deguste',5,1,4)
INSERT INTO TB_PLATILLO VALUES('Brownies','Sabe muy bien elíjalo para su deguste',4,1,4)
INSERT INTO TB_PLATILLO VALUES('Budín Navideño','Sabe muy bien elíjalo para su deguste',6,1,4)
INSERT INTO TB_PLATILLO VALUES('Budin de Pan','Sabe muy bien elíjalo para su deguste',4,1,4)
INSERT INTO TB_PLATILLO VALUES('Buñuelos','Sabe muy bien elíjalo para su deguste',5,1,4)
INSERT INTO TB_PLATILLO VALUES('Cake Volteado de Piña','Sabe muy bien elíjalo para su deguste',6,1,4)
INSERT INTO TB_PLATILLO VALUES('Cachangas','Sabe muy bien elíjalo para su deguste',5,1,4)
INSERT INTO TB_PLATILLO VALUES('Camote con Dulce','Sabe muy bien elíjalo para su deguste',3,1,4)
INSERT INTO TB_PLATILLO VALUES('Camotillo','Sabe muy bien elíjalo para su deguste',4,1,4)
INSERT INTO TB_PLATILLO VALUES('Champús de Guanábana','Sabe muy bien elíjalo para su deguste',5,1,2)


--BEBIDAS--
INSERT INTO TB_PLATILLO VALUES('Mojito','El mojito es el rey extraoficial de Cuba, y de medio mundo. Como la caipirinha, es uno de los combinados más populares del mundo, sobre todo en los últimos años en que ha experimentado un auge. Aunque a decir verdad, ya tiene sus años, porque se inventó en la época de la Ley Seca americana...',11,1,3)
INSERT INTO TB_PLATILLO VALUES('Blue Hawaii','El primer Blue Hawaii lo hizo Harry Yee, el jefe de los barman del hotel Hilton Hawaiian Village en Waikiki. Yee tuvo que crear un cocktail de color azul cuando un representante de una conocida destilería le exigió una bebida con esa tonalidad, ya que estaba promocionando el Curaçao. Aunque la... ',11,1,3)
INSERT INTO TB_PLATILLO VALUES('Margarita','Tequila, Triple sec o Cointreau, y zumo bien de limón, bien de lima. Hielo opcional, sal en los bordes del vaso también optativa. Hasta aquí la receta del margarita, posiblemente el cocktail de tequila más popular del mundo. Sus variantes tienen una pinta deliciosa, pero lo más curioso es el...',11,1,3)
INSERT INTO TB_PLATILLO VALUES('Daiquiri','Pensar en Daiquiri es pensar en playa, palmeras, música, verano... es pensar en Cuba. Allí nace este cocktail que se pide en los bares de todo el mundo y que tiene como alcohol básico el ron blanco. El daiquiri debe su nombre a una playa cercana a Santiago de Cuba y su origen a un americano... ',12,1,3)
INSERT INTO TB_PLATILLO VALUES('Cosmopolitan','Son varios nombres los que se disputan la creación del Cosmopolitan. Algunos creen que fue una comunidad gay de Provincetown (Massachussets), en los años 70. Otros creen que fue Neal Murray en su churrasquería Cork & Cleaver, en el año 1975. Un tercer grupo apuesta por Cheryl Cook, que en el año..',15,1,3)
INSERT INTO TB_PLATILLO VALUES('Caipirinha','La caipirinha es uno de los cocktails más famosos del mundo, de origen brasileño pero muy extendido por todas partes en los últimos años. El ingrediente principal y básico es la cachaça, la bebida alcohólica destilada más popular de Brasil. Se trata de un aguardiente que se obtiene como producto...',10,1,3)
INSERT INTO TB_PLATILLO VALUES('White Russian','Ideal para después de cenar, el White Russian se hizo famoso entre la gente joven porque era la bebida favorita de The Dude, el protagonista de El Gran Lebowski. Hoy te enseñamos su receta. ¿De dónde puede ser un cocktail que se llama White Russian? De Rusia, ¿verdad? Pues no. Recibe ese... ',12,1,3)
INSERT INTO TB_PLATILLO VALUES('Long Island Iced Tea','En el mundo de los cocktails, hay una combinación nefasta: buen sabor y buena cantidad de alcohol. Nefasta, claro, para tu estabilidad y para tu hígado, que es el principal damnificado de que algunas bebidas entren tan bien. El Long Island Iced Tea forma parte de ese grupo, así que vaya por...',15,1,3)
INSERT INTO TB_PLATILLO VALUES('Bahama Mama','¿Harto de clásicos del verano como el mojito o la capirinha? Prueba con el dulce y exótico Bahama Mama, un cocktail que triunfa en el Caribe. Allí se lo beben dentro de cocos recién cogidos, aquí nos tendremos que conformar con un vaso alto... Bahama Mama no es sólo el título de una canción...',12,1,3)
INSERT INTO TB_PLATILLO VALUES('Mojito Royal','Si existiera el rey de los cocktails, sin duda el mojito estaría entre los aspirantes a llevar la corona. Originario de Cuba, cuenta con millones de seguidores en todo el mundo gracias a su acertada mezcla de lima, menta y ron. Debido a ese éxito, no es extraño encontrar diversas variaciones a',15,1,3)
INSERT INTO TB_PLATILLO VALUES('Mai Tai','El Mai Tai nació en el restaurante Trader Vic de Oakland (California) en el año 1944, aunque, como sucede con muchos cocktails, son varios los que se apuntan su autoría. Uno de ellos, antiguo rival del creador de Trader Vic, es Don the Beachcomber, que también disponía de varios restaurantes con... ',14,1,3)
INSERT INTO TB_PLATILLO VALUES('Coco Loco','El mundo está dividido en dos tipos de personas: los que les gusta el coco y los que no tienen paladar. Para los primeros, os traemos la receta del Coco Loco, un refrescante cocktail veraniego con muchísimo sabor al fruto de la palmera. Del Coco Loco existen dos versiones, una que se sirve en...',14,1,3)
INSERT INTO TB_PLATILLO VALUES('Oceans','La historia de este combinado es bastante peculiar, ya que nace como respuesta a un desafío de La Voz de Galicia a una serie de cocteleros de A Coruña, a los que se les propuso captar la esencia de la ciudad en un cocktail. El resultado gustó a los responsables de Santa Teresa, el alcohol... ',10,1,3)
INSERT INTO TB_PLATILLO VALUES('DVicio','Refrescante y de gustos tropicales, el DVicio fue uno de los cocktails estrella que se presentaron en el Taller de los Sentidos dentro del Salón de Gourmets 2011. Así que si quieres estar a la última en el mundo de los combinados, ¡aprende a hacer un DVicio! Del 11 al 14 de abril, la Feria...',8,1,3)
INSERT INTO TB_PLATILLO VALUES('Manhattan','Su origen, evidentemente, hay que buscarlo en la isla de Manhattan, puro Nueva York. Y nos tenemos que remontar a la década de 1870, cuando en el Manhattan Club de la ciudad a alguien le dio por mezclar sus ingredientes en honor a una cena dada para el candidato presidencial de turno. La bebida... ',8,1,3)
INSERT INTO TB_PLATILLO VALUES('Gintonic (x3)','Recetas de gintonic hay tantas como formas de escribir la propia palabra. ¿Gintonic? ¿Gin-Tonic? ¿Gin&Tonic? ¿GinTonic? Todas hacen referencia a lo mismo, a esa copa transparente llena de hielo que mezcla ginebra y tónica, pero hay pequeños detalles que las diferencian. Igual que sus recetas... ',7,1,3)
INSERT INTO TB_PLATILLO VALUES('Zombie','Sus primeros pasos se dan en la década de los 30. El cocktail fue inventado por Ernest Raymond Beaumont-Gannt en el Hollywoods Don Beachcomber Restaurant. El Zombie se popularizó poco después, en la década posterior. Ingredientes 3.5 cl. de zumo de limón 3 cl. de ron negro 2 cl. de zumo... ',7,1,3)
INSERT INTO TB_PLATILLO VALUES('Tom Collins','El Tom Collins aparecía en 1876 en la The Bartenders Guide de Thomas, y poco después ya era un cocktail popular en los USA. Su receta se ha ido modificando un poco con el paso de los años, hasta quedar más o menos establecida así: Ingredientes 4.5 cl de ginebra 3 cl. de zumo de limón 1... ',14,1,3)
INSERT INTO TB_PLATILLO VALUES('Negroni','Cuando llega la Navidad, los más pequeños de la casa piensan en los regalos y los más mayores en la comida que deben preparar para sus invitados. Una forma original y sencilla de empezar esas veladas es con un cocktail de aperitivo. Como el Negroni. El Negroni es ideal para estas fechas... ',11,1,3)
