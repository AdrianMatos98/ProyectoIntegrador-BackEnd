...
create proc sp_ListarPlatillosXFechas(@fecha1 date,@fecha2 date)
as
begin
	...
	on dp.CODIGO_PLATILLO = pl.CODIGO_PLATILLO
	inner join TB_CATEGORIA c
	on pl.CODIGO_CATEGORIA = c.CODIGO_CATEGORIA
	where FECHA_PEDIDO between isnull(@fecha1,GETDATE()) and isnull(@fecha2,GETDATE())
	group by pl.CODIGO_PLATILLO,pl.NOMBRE_PLATILLO,pl.PRECIO_PLATILLO,c.DESCRIPCION_CATEGORIA
